...
if __package__ is None or __package__ == '':
    PACKAGE_PATH = os.path.join('demixing-diffusion-pytorch')
...
def main():
    ...
    parser.add_argument('--save_folder', default='./results_sem', type=str)
    parser.add_argument('--data_path', default='./SEM_dataset/train/', type=str)
    parser.add_argument('--load_path', default='./results_sem/model.pt', type=str)
